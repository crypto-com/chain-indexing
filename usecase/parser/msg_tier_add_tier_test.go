...
var _ = Describe("ParseMsgCommands", func() {
	Describe("MsgTierAddTier", func() {
		It("should parse tieredrewards.MsgAddTier command in the transaction", func() {
			...
			tx := MustParseTxsResp(usecase_parser_test.TX_MSG_TIER_ADD_TIER_TXS_RESP)
			...
			Expect(cmds).To(Equal([]command.Command{
				command_usecase.NewCreateMsgTierAddTier(
					...
					model.MsgAddTierParams{
						RawMsgAddTier: model.RawMsgAddTier{
							Type:      "/chainmain.tieredrewards.v1.MsgAddTier",
