	...
	Describe("ParseTransactionCommands", func() {
		It("should parse Transaction commands when there is two Msg in one transaction", func() {
			...
			Expect(cmds).To(Equal(
				[]command.Command{
					command_usecase.NewCreateTransaction(
						expectedBlockHeight,
						model.CreateTransactionParams{
							TxHash:   "4936522F7391D425F2A93AD47576F8AEC3947DC907113BE8A2FBCFF8E9F2A416",
							Code:     0,
							Log:      "[{\"msgIndex\":0,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro165tzcrh2yl83g8qeqxueg2g5gzgu57y3fe3kc3\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"tcro184lta2lsyu47vwyp2e8zmtca3k5yq85p6c4vp3\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro165tzcrh2yl83g8qeqxueg2g5gzgu57y3fe3kc3\",\"index\":false},{\"key\":\"amount\",\"value\":\"1000basetcro\",\"index\":false}]}]},{\"msgIndex\":1,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro184lta2lsyu47vwyp2e8zmtca3k5yq85p6c4vp3\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"tcro165tzcrh2yl83g8qeqxueg2g5gzgu57y3fe3kc3\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro184lta2lsyu47vwyp2e8zmtca3k5yq85p6c4vp3\",\"index\":false},{\"key\":\"amount\",\"value\":\"2000basetcro\",\"index\":false}]}]}]",
							MsgCount: 2,
					...
					command_usecase.NewCreateRawTransaction(
						expectedBlockHeight,
						model.CreateRawTransactionParams{
							TxHash: "4936522F7391D425F2A93AD47576F8AEC3947DC907113BE8A2FBCFF8E9F2A416",
							Index:  0,
							Code:   0,
							Log:    "[{\"msgIndex\":0,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro165tzcrh2yl83g8qeqxueg2g5gzgu57y3fe3kc3\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"tcro184lta2lsyu47vwyp2e8zmtca3k5yq85p6c4vp3\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro165tzcrh2yl83g8qeqxueg2g5gzgu57y3fe3kc3\",\"index\":false},{\"key\":\"amount\",\"value\":\"1000basetcro\",\"index\":false}]}]},{\"msgIndex\":1,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro184lta2lsyu47vwyp2e8zmtca3k5yq85p6c4vp3\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"tcro165tzcrh2yl83g8qeqxueg2g5gzgu57y3fe3kc3\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro184lta2lsyu47vwyp2e8zmtca3k5yq85p6c4vp3\",\"index\":false},{\"key\":\"amount\",\"value\":\"2000basetcro\",\"index\":false}]}]}]",
							...
							Messages: []map[string]interface{}{
								{
									...
									"amount": []interface{}{
										map[string]interface{}{"denom": "basetcro", "amount": "1000"},
									},
								},
								{
									"@type":        "/cosmos.bank.v1beta1.MsgSend",
									...
									"amount": []interface{}{
										map[string]interface{}{"denom": "basetcro", "amount": "2000"},
									},
								},
							},
						},
				...
				[]command.Command{
					command_usecase.NewCreateTransaction(
						...
						model.CreateTransactionParams{
							...
							Code:     0,
							Log:      "[{\"msgIndex\":0,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro1feqh6ad9ytjkr79kjk5nhnl4un3wez0ynurrwv\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"tcro1feqh6ad9ytjkr79kjk5nhnl4un3wez0ynurrwv\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro1feqh6ad9ytjkr79kjk5nhnl4un3wez0ynurrwv\",\"index\":false},{\"key\":\"amount\",\"value\":\"1000000000basetcro\",\"index\":false}]}]}]",
							MsgCount: 1,
							Signers: []model.TransactionSigner{
								{
									MaybeKeyInfo: &model.TransactionSignerKeyInfo{
							...
							Messages: []map[string]interface{}{
								{
									...
									"amount": []interface{}{
										map[string]interface{}{"denom": "basetcro", "amount": "1000000000"},
									},
								},
							},
						},
				...
				[]command.Command{
					command_usecase.NewCreateTransaction(
						...
						model.CreateTransactionParams{
							...
							Code:     0,
							Log:      "[{\"msgIndex\":0,\"events\":[{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"send\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro1fmprm0sjy6lz9llv7rltn0v2azzwcwzvk2lsyn\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"tcro1782gn9hzqavecukdaqqclvsnpck4mtz3vwzpxl\",\"index\":false},{\"key\":\"sender\",\"value\":\"tcro1fmprm0sjy6lz9llv7rltn0v2azzwcwzvk2lsyn\",\"index\":false},{\"key\":\"amount\",\"value\":\"100000000basetcro\",\"index\":false}]}]}]",
							MsgCount: 1,
							Signers: []model.TransactionSigner{
								{
									MaybeKeyInfo: &model.TransactionSignerKeyInfo{
		...
		It("should parse Transaction commands when the signer public key is empty", func() {
			...
			Expect(cmds[4]).To(Equal(command_usecase.NewCreateTransaction(
				expectedBlockHeight,
				model.CreateTransactionParams{
					TxHash:   "AC2BD4EF48A13B81641AC1CD3A60894718A66FC597A1353B8ACC4E5B6311DB1D",
					Index:    2,
					Code:     0,
					Log:      "[{\"msgIndex\":0,\"events\":[{\"type\":\"coin_received\",\"attributes\":[{\"key\":\"receiver\",\"value\":\"cosmos1k4r9xelttshp5jq7c9a2khwpyj0r69j7lzhu77\",\"index\":false},{\"key\":\"amount\",\"value\":\"900uatom\",\"index\":false}]},{\"type\":\"coin_spent\",\"attributes\":[{\"key\":\"spender\",\"value\":\"cosmos10v888l3d44rh65mjku0m96dgkegnwcxwpm3har\",\"index\":false},{\"key\":\"amount\",\"value\":\"900uatom\",\"index\":false}]},{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"/cosmos.bank.v1beta1.MsgSend\",\"index\":false},{\"key\":\"sender\",\"value\":\"cosmos10v888l3d44rh65mjku0m96dgkegnwcxwpm3har\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"cosmos1k4r9xelttshp5jq7c9a2khwpyj0r69j7lzhu77\",\"index\":false},{\"key\":\"sender\",\"value\":\"cosmos10v888l3d44rh65mjku0m96dgkegnwcxwpm3har\",\"index\":false},{\"key\":\"amount\",\"value\":\"900uatom\",\"index\":false}]}]}]",
					MsgCount: 1,
					Signers: []model.TransactionSigner{
						{
							MaybeKeyInfo:    nil,
			...
			Expect(cmds[5]).To(Equal(command_usecase.NewCreateRawTransaction(
				expectedBlockHeight,
				model.CreateRawTransactionParams{
					TxHash: "AC2BD4EF48A13B81641AC1CD3A60894718A66FC597A1353B8ACC4E5B6311DB1D",
					Index:  2,
					...
					Messages: []map[string]interface{}{
						{
							...
							"amount": []interface{}{
								map[string]interface{}{"denom": "uatom", "amount": "900"},
							},
						},
					},
				},
		...
		It("should parse Transaction commands when the signer public key is in state", func() {
			...
			Expect(cmds[0]).To(Equal(command_usecase.NewCreateTransaction(
				...
				model.CreateTransactionParams{
					...
					Index:    0,
					Code:     0,
					Log:      "[{\"msgIndex\":0,\"events\":[{\"type\":\"coin_received\",\"attributes\":[{\"key\":\"receiver\",\"value\":\"cro1mzh0ps49m7ur7y8fwhy5xtt06mq7fnk3xuqset\",\"index\":false},{\"key\":\"amount\",\"value\":\"2basecro\",\"index\":false}]},{\"type\":\"coin_spent\",\"attributes\":[{\"key\":\"spender\",\"value\":\"cro1rrnm2rkhrkgelj7j9pxeu7sggv8fde3tkymym7\",\"index\":false},{\"key\":\"amount\",\"value\":\"1basecro\",\"index\":false},{\"key\":\"spender\",\"value\":\"cro1442fdq2t62vqchraj6ujxnhq3gkzq3ra9nt4lc\",\"index\":false},{\"key\":\"amount\",\"value\":\"1basecro\",\"index\":false}]},{\"type\":\"message\",\"attributes\":[{\"key\":\"action\",\"value\":\"/cosmos.bank.v1beta1.MsgMultiSend\",\"index\":false},{\"key\":\"sender\",\"value\":\"cro1rrnm2rkhrkgelj7j9pxeu7sggv8fde3tkymym7\",\"index\":false},{\"key\":\"sender\",\"value\":\"cro1442fdq2t62vqchraj6ujxnhq3gkzq3ra9nt4lc\",\"index\":false},{\"key\":\"module\",\"value\":\"bank\",\"index\":false}]},{\"type\":\"transfer\",\"attributes\":[{\"key\":\"recipient\",\"value\":\"cro1mzh0ps49m7ur7y8fwhy5xtt06mq7fnk3xuqset\",\"index\":false},{\"key\":\"amount\",\"value\":\"2basecro\",\"index\":false}]}]}]",
					MsgCount: 1,
					Signers: []model.TransactionSigner{
						{
							MaybeKeyInfo: &model.TransactionSignerKeyInfo{
			...
			Expect(cmds[1]).To(Equal(command_usecase.NewCreateRawTransaction(
				expectedBlockHeight,
				model.CreateRawTransactionParams{
					TxHash: "C98FF5B5B95DC21F6D614D914FDA0A546DAE65E826ABFFE5C89BCF56A6F4112C",
					Index:  0,
