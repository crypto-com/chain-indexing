...
func ParseMsgSend(
	...
	if parserParams.Msg != nil {
		if fromAddress, ok := parserParams.Msg["from_address"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(fromAddress.(string)))
		}
	}
	...
	return []command.Command{command_usecase.NewCreateMsgSend(
		...
		event.MsgSendCreatedParams{
			FromAddress: utils.ToLowerCase(parserParams.Msg["from_address"].(string)),
			ToAddress:   utils.ToLowerCase(parserParams.Msg["to_address"].(string)),
			Amount:      amount,
		},
...
func ParseMsgMultiSend(
	...
	for _, rawInput := range rawInputs {
		...
		inputs = append(inputs, model.MsgMultiSendInput{
			Address: utils.ToLowerCase(input["address"].(string)),
			Amount:  amount,
		})
	}
	...
	for _, rawOutput := range rawOutputs {
		...
		outputs = append(outputs, model.MsgMultiSendOutput{
			Address: utils.ToLowerCase(output["address"].(string)),
			Amount:  amount,
		})
	}
...
func ParseMsgSetWithdrawAddress(
	...
	if parserParams.Msg != nil {
		if delegatorAddress, ok := parserParams.Msg["delegator_address"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(delegatorAddress.(string)))
		}
	}
	...
	return []command.Command{command_usecase.NewCreateMsgSetWithdrawAddress(
		...
		model.MsgSetWithdrawAddressParams{
			DelegatorAddress: utils.ToLowerCase(parserParams.Msg["delegator_address"].(string)),
			WithdrawAddress:  utils.ToLowerCase(parserParams.Msg["withdraw_address"].(string)),
		},
	)}, possibleSignerAddresses
}
...
func ParseMsgWithdrawDelegatorReward(
	...
	if !parserParams.MsgCommonParams.TxSuccess {
		...
		return []command.Command{command_usecase.NewCreateMsgWithdrawDelegatorReward(
			...
			model.MsgWithdrawDelegatorRewardParams{
				DelegatorAddress: utils.ToLowerCase(delegatorAddress),
				ValidatorAddress: utils.ToLowerCase(parserParams.Msg["validator_address"].(string)),
				RecipientAddress: utils.ToLowerCase(delegatorAddress),
	...
	return []command.Command{command_usecase.NewCreateMsgWithdrawDelegatorReward(
		...
		model.MsgWithdrawDelegatorRewardParams{
			DelegatorAddress: utils.ToLowerCase(parserParams.Msg["delegator_address"].(string)),
			ValidatorAddress: utils.ToLowerCase(parserParams.Msg["validator_address"].(string)),
			RecipientAddress: utils.ToLowerCase(recipient),
			Amount:           amount,
		},
	)}, possibleSignerAddresses
}
...
func ParseMsgWithdrawValidatorCommission(
	...
	if parserParams.Msg != nil {
		if validatorAddress, ok := parserParams.Msg["validator_address"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(validatorAddress.(string)))
		}
	}
...
func ParseMsgFundCommunityPool(
	...
	if parserParams.Msg != nil {
		if depositor, ok := parserParams.Msg["depositor"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(depositor.(string)))
		}
	}
	...
	return []command.Command{command_usecase.NewCreateMsgFundCommunityPool(
		...
		model.MsgFundCommunityPoolParams{
			Depositor: utils.ToLowerCase(parserParams.Msg["depositor"].(string)),
			Amount:    amount,
		},
	)}, possibleSignerAddresses
}
...
func parseMsgSubmitParamChangeProposal(
	...
	if msg != nil {
		if proposer, ok := msg["proposer"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(proposer.(string)))
		}
	}
	...
	if !txSuccess {
		return []command.Command{command_usecase.NewCreateMsgSubmitParamChangeProposal(
			...
			model.MsgSubmitParamChangeProposalParams{
				...
				ProposerAddress: utils.ToLowerCase(msg["proposer"].(string)),
...
func parseMsgSubmitCommunityFundSpendProposal(
	...
	proposalContent := model.MsgSubmitCommunityPoolSpendProposalContent{
		...
		RecipientAddress: utils.ToLowerCase(rawProposalContent.RecipientAddress),
		Amount:           amount,
	}
...
func ParseMsgVote(
	...
	if parserParams.Msg != nil {
		if voter, ok := parserParams.Msg["voter"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(voter.(string)))
		}
	}
	...
	return []command.Command{command_usecase.NewCreateMsgVote(
		...
		model.MsgVoteParams{
			...
			Voter:      utils.ToLowerCase(parserParams.Msg["voter"].(string)),
	...
	if !parserParams.MsgCommonParams.TxSuccess {
		return []command.Command{command_usecase.NewCreateMsgBeginRedelegate(
			...
			model.MsgBeginRedelegateParams{
				DelegatorAddress:    utils.ToLowerCase(parserParams.Msg["delegator_address"].(string)),
				ValidatorSrcAddress: utils.ToLowerCase(parserParams.Msg["validator_src_address"].(string)),
				ValidatorDstAddress: utils.ToLowerCase(parserParams.Msg["validator_dst_address"].(string)),
				Amount:              amount,
				AutoClaimedRewards:  coin.Coin{},
			},
		)}, possibleSignerAddresses
...
func ParseMsgUnjail(
	...
	if parserParams.Msg != nil {
		if validatorAddr, ok := parserParams.Msg["validator_addr"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(validatorAddr.(string)))
		}
	}
	...
	return []command.Command{command_usecase.NewCreateMsgUnjail(
		...
		model.MsgUnjailParams{
			ValidatorAddr: utils.ToLowerCase(parserParams.Msg["validator_addr"].(string)),
		},
	)}, possibleSignerAddresses
}
...
func parseGenesisGenTxsMsgCreateValidator(
	...
	return []command.Command{command_usecase.NewCreateGenesisValidator(
		genesis.CreateGenesisValidatorParams{
			...
			DelegatorAddress:  utils.ToLowerCase(msg["delegator_address"].(string)),
			ValidatorAddress:  utils.ToLowerCase(msg["validator_address"].(string)),
...
func ParseMsgNFTIssueDenom(
	...
	if parserParams.Msg != nil {
		if sender, ok := parserParams.Msg["sender"]; ok {
			possibleSignerAddresses = append(possibleSignerAddresses, utils.ToLowerCase(sender.(string)))
		}
	}
	...
	return []command.Command{command_usecase.NewCreateMsgNFTIssueDenom(
		...
		model.MsgNFTIssueDenomParams{
			...
			Sender:    utils.ToLowerCase(parserParams.Msg["sender"].(string)),
		},
	)}, possibleSignerAddresses
}
...
func ParseMsgNFTMintNFT(
	...
	return []command.Command{command_usecase.NewCreateMsgNFTMintNFT(
		...
		model.MsgNFTMintNFTParams{
			...
			Sender:    utils.ToLowerCase(parserParams.Msg["sender"].(string)),
			Recipient: utils.ToLowerCase(parserParams.Msg["recipient"].(string)),
		},
	)}, possibleSignerAddresses
}
...
func parseRawMsgSendGrant(
	...
	rawMsg.Grantee = utils.ToLowerCase(rawMsg.Grantee)
	rawMsg.Granter = utils.ToLowerCase(rawMsg.Granter)
...
func ParseMsgCreateVestingAccount(
	...
	rawMsg.FromAddress = utils.ToLowerCase(rawMsg.FromAddress)
	rawMsg.ToAddress = utils.ToLowerCase(rawMsg.ToAddress)
...
func ParseMsgEthereumTx(
	...
	rawMsg.From = utils.ToLowerCase(rawMsg.From)
