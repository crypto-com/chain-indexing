...
var _ = Describe("ParseMsgCommands", func() {
	Describe("MsgTierClearPosition", func() {
		It("should parse tieredrewards.MsgClearPosition command in the transaction", func() {
			...
			tx := MustParseTxsResp(usecase_parser_test.TX_MSG_TIER_CLEAR_POSITION_TXS_RESP)
			...
			Expect(cmds).To(Equal([]command.Command{
				command_usecase.NewCreateMsgTierClearPosition(
