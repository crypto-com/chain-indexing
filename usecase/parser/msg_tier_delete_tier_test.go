...
var _ = Describe("ParseMsgCommands", func() {
	Describe("MsgTierDeleteTier", func() {
		It("should parse tieredrewards.MsgDeleteTier command in the transaction", func() {
			...
			tx := MustParseTxsResp(usecase_parser_test.TX_MSG_TIER_DELETE_TIER_TXS_RESP)
			...
			Expect(cmds).To(Equal([]command.Command{
				command_usecase.NewCreateMsgTierDeleteTier(
