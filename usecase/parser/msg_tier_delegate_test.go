...
var _ = Describe("ParseMsgCommands", func() {
	Describe("MsgTierDelegate", func() {
		It("should parse tieredrewards.MsgTierDelegate command in the transaction", func() {
			...
			tx := MustParseTxsResp(usecase_parser_test.TX_MSG_TIER_DELEGATE_TXS_RESP)
			...
			Expect(cmds).To(Equal([]command.Command{
				command_usecase.NewCreateMsgTierDelegate(
					...
					model.MsgTierDelegateParams{
						RawMsgTierDelegate: model.RawMsgTierDelegate{
							Type:       "/chainmain.tieredrewards.v1.MsgTierDelegate",
							Owner:      "cro1dulwqgcdpemn8c34sjd92fxepz5p0sqpeevw84",
							PositionId: "789",
							Validator:  "crocncl1kkqxv3szgh099xezt7y38t5anqzue4s3fhp2tm",
						},
					},
				),
			}))
