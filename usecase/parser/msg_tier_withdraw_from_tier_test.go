...
var _ = Describe("ParseMsgCommands", func() {
	Describe("MsgTierWithdrawFromTier", func() {
		It("should parse tieredrewards.MsgWithdrawFromTier command in the transaction", func() {
			...
			tx := MustParseTxsResp(usecase_parser_test.TX_MSG_TIER_WITHDRAW_FROM_TIER_TXS_RESP)
			...
			Expect(cmds).To(Equal([]command.Command{
				command_usecase.NewCreateMsgTierWithdrawFromTier(
					...
					model.MsgWithdrawFromTierParams{
