...
`, &anyRawValue)
			...
			var anyRawMsgRecvPacketFungibleTokenPacketData ibc_model.RawMsgRecvPacketFungibleTokenPacketData
...
`, &anyRawValue)
			...
			anyParams := ibc_model.MsgRecvPacketParams{
				...
				MaybeFungibleTokenPacketData: &ibc_model.MsgRecvPacketFungibleTokenPacketData{
					RawMsgRecvPacketFungibleTokenPacketData: anyRawMsgRecvPacketFungibleTokenPacketData,
					Success:                                 true,
