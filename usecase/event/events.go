...
func RegisterEvents(registry *event.Registry) {
	...
	// Tiered Rewards
	registry.Register(MSG_TIER_LOCK_TIER_CREATED, 1, DecodeMsgTierLockTier)
	registry.Register(MSG_TIER_LOCK_TIER_FAILED, 1, DecodeMsgTierLockTier)
	registry.Register(MSG_TIER_COMMIT_DELEGATION_TO_TIER_CREATED, 1, DecodeMsgTierCommitDelegationToTier)
	registry.Register(MSG_TIER_COMMIT_DELEGATION_TO_TIER_FAILED, 1, DecodeMsgTierCommitDelegationToTier)
	registry.Register(MSG_TIER_ADD_TO_TIER_POSITION_CREATED, 1, DecodeMsgTierAddToTierPosition)
	registry.Register(MSG_TIER_ADD_TO_TIER_POSITION_FAILED, 1, DecodeMsgTierAddToTierPosition)
	registry.Register(MSG_TIER_DELEGATE_CREATED, 1, DecodeMsgTierDelegate)
	registry.Register(MSG_TIER_DELEGATE_FAILED, 1, DecodeMsgTierDelegate)
	registry.Register(MSG_TIER_REDELEGATE_CREATED, 1, DecodeMsgTierRedelegate)
	registry.Register(MSG_TIER_REDELEGATE_FAILED, 1, DecodeMsgTierRedelegate)
	registry.Register(MSG_TIER_UNDELEGATE_CREATED, 1, DecodeMsgTierUndelegate)
	registry.Register(MSG_TIER_UNDELEGATE_FAILED, 1, DecodeMsgTierUndelegate)
	registry.Register(MSG_TIER_TRIGGER_EXIT_FROM_TIER_CREATED, 1, DecodeMsgTierTriggerExitFromTier)
	registry.Register(MSG_TIER_TRIGGER_EXIT_FROM_TIER_FAILED, 1, DecodeMsgTierTriggerExitFromTier)
	registry.Register(MSG_TIER_CLEAR_POSITION_CREATED, 1, DecodeMsgTierClearPosition)
	registry.Register(MSG_TIER_CLEAR_POSITION_FAILED, 1, DecodeMsgTierClearPosition)
	registry.Register(MSG_TIER_WITHDRAW_FROM_TIER_CREATED, 1, DecodeMsgTierWithdrawFromTier)
	registry.Register(MSG_TIER_WITHDRAW_FROM_TIER_FAILED, 1, DecodeMsgTierWithdrawFromTier)
	registry.Register(MSG_TIER_CLAIM_TIER_REWARDS_CREATED, 1, DecodeMsgTierClaimTierRewards)
	registry.Register(MSG_TIER_CLAIM_TIER_REWARDS_FAILED, 1, DecodeMsgTierClaimTierRewards)
	registry.Register(MSG_TIER_EXIT_TIER_WITH_DELEGATION_CREATED, 1, DecodeMsgTierExitTierWithDelegation)
	registry.Register(MSG_TIER_EXIT_TIER_WITH_DELEGATION_FAILED, 1, DecodeMsgTierExitTierWithDelegation)
	registry.Register(MSG_TIER_ADD_TIER_CREATED, 1, DecodeMsgTierAddTier)
	registry.Register(MSG_TIER_ADD_TIER_FAILED, 1, DecodeMsgTierAddTier)
	registry.Register(MSG_TIER_UPDATE_TIER_CREATED, 1, DecodeMsgTierUpdateTier)
	registry.Register(MSG_TIER_UPDATE_TIER_FAILED, 1, DecodeMsgTierUpdateTier)
	registry.Register(MSG_TIER_DELETE_TIER_CREATED, 1, DecodeMsgTierDeleteTier)
	registry.Register(MSG_TIER_DELETE_TIER_FAILED, 1, DecodeMsgTierDeleteTier)
	...
	registry.Register(MSG_SUBMIT_TX_FAILED, 1, DecodeMsgSubmitTx)
}
