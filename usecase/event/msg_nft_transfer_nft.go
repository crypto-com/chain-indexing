...
const MSG_NFT_TRANSFER_NFT = "MsgNFTTransferNFT"
const MSG_NFT_TRANSFER_NFT_CREATED = "MsgNFTTransferNFTCreated"
const MSG_NFT_TRANSFER_NFT_FAILED = "MsgNFTTransferNFTFailed"
