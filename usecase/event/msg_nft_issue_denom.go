...
const MSG_NFT_ISSUE_DENOM = "MsgNFTIssueDenom"
const MSG_NFT_ISSUE_DENOM_CREATED = "MsgNFTIssueDenomCreated"
const MSG_NFT_ISSUE_DENOM_FAILED = "MsgNFTIssueDenomFailed"
