...
func (server *HTTPAPIServer) Run() error {
	...
	infoHandler := handlers.NewInfo(server.logger, server.rdbConn.ToHandle())
	routeRegistry := routes.NewRoutesRegistry(blocksHandler, transactionsHandler, infoHandler)
