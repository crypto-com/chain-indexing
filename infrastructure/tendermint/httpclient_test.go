...
var _ = Describe("HTTPClient", func() {
	...
	Describe("RawBlockResults", func() {
		...
		It("should return parsed block results when validator updates has no power", func() {
			...
			blockResults, err := client.BlockResults(anyBlockHeight)
			Expect(err).To(BeNil())
			Expect(jsoniter.MarshalToString(blockResults)).To(Equal("{\"BlockHeight\":4794,\"TxsResults\":[],\"BeginBlockEvents\":[],\"EndBlockEvents\":[],\"ValidatorUpdates\":[{\"PubKey\":{\"type\":\"tendermint.crypto.PublicKey_Ed25519\",\"pubKey\":\"CpCz+c19SHaNWW31P+7blzyHo0sQMn4uk8gIej+pXW8=\",\"address\":\"02D50170AFB2B3718477AA607469BEA96C80CE88\"},\"power\":null}],\"ConsensusParamUpdates\":{\"block\":{\"maxBytes\":\"22020096\",\"maxGas\":\"-1\"},\"evidence\":{\"maxAgeNumBlocks\":\"100000\",\"maxAgeDuration\":\"172800000000000\",\"maxBytes\":\"\"},\"validator\":{\"pubKeyTypes\":[\"ed25519\"]}}}"))
		})
	})
