...
func (conv *PgxTypeConv) NtobReader() appinterface.RDbNtobReader {
...
func (conv *PgxTypeConv) Tton(t *time.Time) interface{} {
	if t == nil {
		return nil
	}
...
func (conv *PgxTypeConv) NtotReader() appinterface.RDbNtotReader {
...
func (reader *PgxNtotReader) Parse() (*time.Time, error) {
