...
require (
	github.com/crypto-com/chain-indexing v1.3.11
...
require (
	...
	github.com/calvinlauyh/cosmosutils v0.1.0 // indirect
	...
	github.com/crypto-org-chain/cronos v0.6.0-testnet // indirect
