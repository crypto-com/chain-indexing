...
func (accountRawEventsView *MockAccountRawEventsView) Insert(messageRow *AccountRawEventRow, accounts []string) error {
	// messageRow.MaybeId = "TESTUUID"
	...
	mockArgs := accountRawEventsView.Called(messageRow, accounts)
